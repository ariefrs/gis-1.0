...
$string .= "\n\n    public function index()
    {
        ...
        \$data = array(
            ...
            'start' \t\t\t=> \$start,
            'title' \t\t\t=> 'Data ".ucfirst($c_url)."',
            'main_content' \t\t\t=> '$c_url/$v_list',
        );
        \$this->load->view('includes/adminlte', \$data);
    }";
...
$string .= "\n\t    );
            \$data['main_content'] = '$c_url/$v_read';
            \$data['title'] = 'Detail Data ".ucfirst($c_url)."';
            \$this->load->view('includes/adminlte', \$data);
        } else {
...
$string .= "\n\t);
        \$data['title'] = 'Form ".ucfirst($c_url)."';
        \$data['main_content'] = '$c_url/$v_form';
        \$this->load->view('includes/adminlte', \$data);
    }
...
$string .= "\n\t    );
            \$data['title'] = 'Form Update ".ucfirst($c_url)."';
            \$data['main_content'] = '$c_url/$v_form';
            \$this->load->view('includes/adminlte', \$data);
        } else {
            \$this->session->set_flashdata('message', 'Record Not Found');
